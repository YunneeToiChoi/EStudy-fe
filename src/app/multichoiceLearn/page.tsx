              ...
              <div className="content__box">
                ...
                <div className="multichoice__box">
                  <div className="multichoice__answer">
                    <Link href="" className="multichoice__link">conference</Link>
                    <Link href="" className="multichoice__link">sometime</Link>
                    <Link href="" className="multichoice__link">supervisor</Link>
                    <Link href="" className="multichoice__link">candidates</Link>
                  </div>
                </div>
              </div>
