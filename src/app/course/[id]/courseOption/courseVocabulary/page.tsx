...
import {BreadcrumbWithCustomSeparator} from '@/components/handicraft/params/paramsCourseVocabulary';
    ...
    return(
        <div>
            ...
            <label className="lg:hidden" htmlFor="nav-mobile-course-checkbox"
              ><i className="fa-solid fa-bars text-xl mr-5 cursor-pointer"></i></label>
          </nav>
          <input
            type="checkbox"
          ...
          <div className="flex py-[60px]">
            <div className="mx-auto max-2xl:mx-[40px] w-[1000px] grid">
              <h1 className="text-3xl font-semibold mt-[50px]">Từ vựng TOEIC</h1>
