...
import userReducer from "@/service/reduxState/userSlices";
...
const ThunkReducer = combineReducers({courses: courseReducer, order: orderReducer, paymentMomo: paymentMomoReducer,user: userReducer});
